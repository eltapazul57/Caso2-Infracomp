...
public class Imagen {
    ...
    public String crearReferencias(int tamanioPaginas, int numPaginas, int numReferencias) {
        int pagina = 0;
        ...
        // agregar el último bit de la longitud
        mensaje = mensaje + "Imagen[0]" + "[" + 5 + "]" + auxRGB(0) + "," + pagina + "," + desplazamiento + ",R" + "\n";
        referencia++;
        desplazamiento = desplazamiento + 1;
        if (desplazamiento == tamanioPaginas) {
            desplazamiento = 0;
        ...
        while (contadorMensaje != longitud) {
            ...
            if (contadorBits == -1) {
                mensaje = mensaje + "mensaje[" + indiceMensaje + "]" + "," + paginaMensaje + "," + desplazamientoMensaje
                        + ",W" + "\n";
            } else {
                mensaje = mensaje + "mensaje[" + indiceMensaje + "]" + "," + paginaMensaje + "," + desplazamientoMensaje
                        + ",W" + "\n";
